...
public class LocationService {
    ...
    public AddressResponse getProvinceById(String provinceId) {
        Province province = provinceRepository.findById(provinceId).orElseThrow(() -> new NotFound("Can not find province with Id " + provinceId));
    ...
    public AddressResponse getDistrictById(String districtId) {
        District district = districtRepository.findById(districtId).orElseThrow(() -> new NotFound("Can not find district with Id " + districtId));
        AddressResponse response = new AddressResponse();
    ...
    public AddressResponse getWardById(String wardId) {
        Ward ward = wardRepository.findById(wardId).orElseThrow(() -> new NotFound("Can not find ward with Id " + wardId));
        AddressResponse response = new AddressResponse();
